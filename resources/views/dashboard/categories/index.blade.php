...
@section('content')
    <div class="w-75">
        ...
        <form method="POST" action="/dashboard/categories">
            ...
            <button type="submit" class="btn samazon-submit-button my-2">＋新規作成</button>
        </form>
                ...
                @foreach( $categories as $category )
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/dashboard/categories/{{ $category->id }}" id="logout-form" method="POST" style="display: none;">
                                @csrf
