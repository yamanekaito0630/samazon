        ...
        <div class="w-75">
            <form method="GET" action="/dashboard/orders">
                <div class="d-flex flex-inline form-group">
                    ...
                    <input id="search-products" name="code" class="form-controll mx-2 w-50" placeholder="123456789" value="{{ $code }}" />
                </div>
                <button type="submit" class="btn samazon-submit-button mt-3">検索</button>
            </form>
        </div>
