            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div class="row">
                        ...
                        <div class="col-9 d-flex align-items-center mx-2 my-3">
                            <div class="d-flex flex-column">
                                <label for="user_name">会員情報の編集</label>
                                <p>アカウント情報の編集</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div class="row">
                        ...
                        <div class="col-9 d-flex align-items-center mx-2 mt-3">
                            <div class="d-flex flex-column">
            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div class="row">
                        ...
                        <div class="col-9 d-flex align-items-center my-3 mx-2">
                            <div class="d-flex flex-column">
